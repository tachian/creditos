...
_ALLOWED_SAFE_DETAIL_KEYS = frozenset(
    {
        ...
        "execution_id",
        "factor_count",
        "fallback_action_reject_by_policy",
        "fallback_action_request_more_data",
        "fallback_action_unable_to_decide",
        "fallback_action",
        ...
        "outcome",
        "outcome_approve",
        "outcome_approve_with_changes",
        "outcome_reject",
        "outcome_request_more_data",
        "outcome_unable_to_decide",
        "permission_scope",
        "policy_id",
        "policy_revision",
        "policy_version",
        "policy_version_id",
        "previous_catalog_version_id",
        ...
        "review_purpose_count",
        "revision",
        "schema_version",
        "simulation_id",
        "simulation_issue_count",
